...
if __name__ == '__main__':
    # parse user input
    print("Starting neural grid... 09.02.18 ...15:45")
    ...
    parser.set_defaults(
        ...
        data_dir="./data/"
        , log_file="log"
        , model_dir="./saved_models/08_02/gridCNN_multi/09_02_gridCNN_multi_epoch_"
    ...
    # Forward propagation
    score_positive, score_negative, parameters = forward_propagation(X_positive, X_negative, vocab, E, mode,
                                                                     print_=True)
