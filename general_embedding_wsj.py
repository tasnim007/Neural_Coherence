...
if __name__ == '__main__':
    # parse user input
    print("Starting Single embedding...09/02/18...16:10")
    ...
    parser.set_defaults(
        ...
        data_dir="./data/"
        , log_file="log"
        , model_dir="./saved_models/08_02/pretrained_multi/09_02_pretrained_multi_epoch_"
    ...
    print("\nsaving model at:", opts.model_dir)
    ...
    if opts.pretrained == 1:
        ...
        E = data_helper.load_pretrained_embedding(vocabs=vocab_0, filename="./word2vec/GoogleNews-vectors-negative300.bin.txt", pretrained_type=opts.pretrained_type)
